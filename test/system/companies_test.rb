...
class CompaniesTest < ApplicationSystemTestCase
  ...
  test "should create company" do
    ...
    fill_in "Currency", with: @company.currency
    fill_in "Description", with: @company.description
    fill_in "Employees count", with: @company.employees_count
    check "Hidden" if @company.hidden
    fill_in "Location", with: @company.location
    fill_in "Name", with: @company.name
    fill_in "Plan", with: @company.plan
    fill_in "Subdomain", with: @company.subdomain
    check "Subscribed" if @company.subscribed
    fill_in "Tenant", with: @company.tenant_id
